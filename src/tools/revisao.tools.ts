...
const CHECKLIST: Record<string, { descricao: string; itens: Array<{ id: string; item: string; como_verificar: string; critico: boolean }> }> = {
  ...
  estrutura: {
    descricao: 'Estrutura obrigatória — PARECER JURÍDICO - TRIBUTÁRIO E FISCAL (padrão Guerra Advogados)',
    itens: [
      { id: 'E1', item: 'Cabeçalho: tabela com EXATAMENTE 4 campos — CONSULENTE | DATA | ASSUNTO | LEGISLAÇÃO', como_verificar: 'Confirmar presença das 4 linhas no tbl_cab — sem ELABORAÇÃO, sem PARECERISTAS, sem EMITIDO POR', critico: true },
      { id: 'E2', item: 'EMENTA — parágrafo em MAIÚSCULAS após o cabeçalho, antes de I. RELATÓRIO', como_verificar: 'Presente, todo em maiúsculas, temas separados por ponto, máx. 8 linhas, reflete a conclusão jurídica adotada', critico: true },
      { id: 'E3', item: 'I. RELATÓRIO — contextualização sem conclusões (apenas fatos e perguntas)', como_verificar: 'Seção presente; sem antecipação de entendimento; identifica as perguntas da consulente', critico: true },
  ...
  modo_parecer: {
    ...
    itens: [
      ...
      { id: 'M4', item: 'Modo Geral: 6 elementos em extensão integral (Cabeçalho, EMENTA, I. RELATÓRIO, II. FUNDAMENTAÇÃO, III. EXEMPLOS PRÁTICOS, IV. CONCLUSÃO, ASSINATURA)', como_verificar: 'Verificar presença e extensão adequada de cada elemento — N/A se modo=empresarial', critico: true },
      { id: 'M5', item: 'Modo Empresarial: elementos condensados — nenhum pode ser omitido (A Situação, A Resposta, Exemplos, Conclusão, Assinatura)', como_verificar: 'Verificar todos os elementos presentes mesmo que em 2-4 linhas — N/A se modo=geral', critico: true },
      ...
      { id: 'M7', item: 'Título correto: "PARECER JURÍDICO - TRIBUTÁRIO E FISCAL" (Geral) ou "NOTA TÉCNICA TRIBUTÁRIA" (Empresarial)', como_verificar: 'Verificar o título no script Python e no DOCX gerado', critico: true },
    ],
  },
  revalidacao_tecnica: {
